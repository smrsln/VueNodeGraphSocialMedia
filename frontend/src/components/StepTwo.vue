            ...
            <div class="friend-item-content">
              <div class="friend-avatar">
                <div class="author-thumb">
                  <img
                    class="mt-3"
                    style="width:100px; height:100px; -webkit-box-shadow: 0px 0px 22px -2px rgba(0,0,0,0.71); -moz-box-shadow: 0px 0px 22px -2px rgba(0,0,0,0.71); box-shadow: 0px 0px 22px -2px rgba(0,0,0,0.71);"
                    :src="'../../assets/profile_pics/' + useradvice.profile_pics"
                  >
                </div>
                <div class="author-content mt-4">
                  ...
                  <div v-if="useradvice.followedStatus == 1" class="country mt-3">
                    <button
                      style="background-color:green;"
                      @click.prevent="followControl(useradvice.userId,useradvice.followedStatus)"
                      type="button"
                      class="btn btn-sm"
                    >
                  ...
                  <div v-else class="country mt-3">
                    <button
                      @click.prevent="followControl(useradvice.userId,followedStatus)"
                      type="button"
